...
//------------------------------------------------ default HTML template -------------------------------------------------
  ...
  HTML_main:function(team_info, activity_id, activity, url, url_team_num, admin_info, alertFlag){
    ...
    if(alertFlag === "noSession"){
      ...
      var backURL = 'http://localhost:8080/teamcc';
          ...
          <head>
            ...
            <script>
              ...
              function deleteFunction(inputText){
                if(inputText == "삭제요청"){
                  location.href = 'http://localhost:8080/teamcc/initialization';
                } else{
              ...
              <div class="container px-5" id="navbar-grid" style="margin: 0; display:grid; grid-template-columns: 30vw 60vw;">
                ...
                <div id="navbar-item" style="grid-column:2; text-align:right;">
                  ...
                  <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <div class="navbar-rg-item"><img onclick="location.href='http://localhost:8080/teamcc/admin_profile'" src="teamcc/assets/img/profileIcon.png" width="40px;"></div>
                  </div>
                </div>
              </div>
            </nav>
                      ...
                      <div class="p-5">
                        <div class="main-grid-user">
                          ...
                          <div class="wrapper" style="grid-row:1; grid-column:3; margin-left:20px; text-align:left; height: 40px; margin-right: 20px;">
                            ...
                            <a href="http://localhost:8080/teamcc/change_url_state" id="change_url_link"></a>
                          </div>
                          <script>
                          ...
                          <div class="main-gallery-div">
                            <a href="http://localhost:8080/teamcc/team_gallery" class="btn btn-primary btn-xl rounded-pill a-usertable">Gallery</a>
                          </div>
                        </div>
          ...
          <body id="page-top">
            ...
            <div class="middlePart">
              ...
              <div style="text-align: center">
                <a href="http://localhost:8080/teamcc/admin_main" class="btn btn-primary btn-xl rounded-pill mt-5" style="width:180px;">BACK</a>
              </div>
              <div id="mid_container">
                <button type="button" id="modal_bt" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modal" style="display:none;"> </button>
              </div>
              ...
              <div class="container px-5">
                ...
                <form style="  margin:auto;width:400px;" action="teamcc/admin_register_state" method="post">
                  <div id="grid">
  		          ...
  		          <a href="http://localhost:8080/teamcc/" class="btn btn-primary btn-xl rounded-pill mt-5" style="width:180px;">BACK</a>
              </div>
            </div>
            <div class="bg-circle-1 bg-circle"></div>
            <div class="bg-circle-2 bg-circle"></div>
          ...
          <script>
            function profile_edit(){
              ...
              $.ajax({
                type:'post',
                async:false,
                url:'http://localhost:8080/teamcc/admin_profile_check',
                dataType:'text',
                data:{
          ...
          <header class="masthead text-center text-white"  >
            <div class="masthead-content" >
              <div class="container px-5" style=" background: #e8e8e85c;border-radius: 10px; padding-bottom: 100px; padding-top: 120px;">
                <div class="closeInfo" onclick="location.href='http://localhost:8080/teamcc/admin_main'">X</div>
          ...
          <script>
            function color_pick(adminID,score,color){
              $.ajax({
                type:'post',
                async:false,
                url:'http://localhost:8080/teamcc/change_color_pick',
                dataType:'text',
                data:{
                  adminID:adminID,
                  score:score,
            ...
            function change_title(adminID,title){
              $.ajax({
                type:'post',
                async:false,
                url:'http://localhost:8080/teamcc/change_title',
                dataType:'text',
                data:{
                  adminID:adminID,
                  title:title.value
            ...
            function change_scoretext(adminID,score,color){
              $.ajax({
                type:'post',
                async:false,
                url:'http://localhost:8080/teamcc/change_color_scoretext',
                dataType:'text',
                data:{
                  adminID:adminID,
                  score:score+'_text',
    ...
    for(var i = 0; i< url.length; i++){
      tag +=`
        <tr>
          ...
          <td class="tdCSS"><a href="http://localhost:8080/teamcc/user?id=${url[i].url}">${url[i].url}</td>
          <td class="tdCSS">
          ...
          <td class="tdCSS">
            <button class="bt-copy" onClick="copy_clipboard('http://localhost:8080/teamcc/user?id=${url[i].url}','img-copy${url[i].team_num}')">
          ...
          <td class="tdCSS">
            ...
            <script type="text/javascript">
              function kakaoShare(url_num) {
                  ...
                  content : {
                    title:"Team CC 링크",
                    description:"http://localhost:8080/teamcc/user?id=" + url_num,  // 콘텐츠 설명
                    imageUrl:"https://ifh.cc/g/7AV4pw.jpg", // 썸네일 같은거
                    link : {
                      mobileWebUrl:"http://localhost:8080/teamcc/user?id=" + url_num,    // 모바일 카카오톡에서 사용하는 웹 링크 URL
                      webUrl:"http://localhost:8080/teamcc/user?id=" + url_num  // PC버전 카카오톡에서 사용하는 웹 링크 URL
                    }
                  },
                  buttons : [{
            ...
            <a href="http://localhost:8080/teamcc/admin_main" id="kakao_href"></a>
